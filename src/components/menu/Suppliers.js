  ...
  return (
    <SuppliersContainer>
      {showEditOrNewRow ? <EditRow actions={suppliersActions} ></EditRow> :
        <div>
          <TableSection>
            <StyledTitle type={"danger"}>ספקים</StyledTitle>
          ...
          <ButtonsSection>
            <StyledButton type="primary" danger onClick={() => { suppliersActions.backToMenuPage() }}>חזרה לתפריט</StyledButton>
            <StyledButton type="primary" onClick={() => { suppliersActions.createRow() }}>חדש</StyledButton>
            <StyledButton type="primary" danger onClick={() => { suppliersActions.deleteRow() }}>מחק</StyledButton>
            <StyledButton type="primary" onClick={() => { suppliersActions.editRow() }}>ערוך</StyledButton>
          </ButtonsSection>
        </div>
      }
    </SuppliersContainer>
