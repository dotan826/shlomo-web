...
const columns = [
  ...
  {
    title: <Typography.Text strong>חברה</Typography.Text>,
    dataIndex: 'חברה',
    width: 100,
  },
  {
  ...
  {
    title: <Typography.Text strong>גימור</Typography.Text>,
    dataIndex: 'גימור',
    width: 100,
  },
  {
  ...
  {
    title: <Typography.Text strong>משקל</Typography.Text>,
    dataIndex: 'משקל',
    width: 100,
  },
  {
  ...
  {
    title: <Typography.Text strong>מק"ט ספק</Typography.Text>,
    dataIndex: 'מקט ספק',
    width: 100,
  },
  {
    title: <Typography.Text strong>דגם</Typography.Text>,
    dataIndex: 'דגם',
    width: 100,
  },
  {
  ...
  return (
    <AffixingContainer>
      {showEditOrNewRow ? <EditRow actions={affixingActions} ></EditRow> :
        <div>
          <TableSection>
            <StyledTitle type={"danger"}>פרזול</StyledTitle>
          ...
          <ButtonsSection>
            <StyledButton type="primary" danger onClick={() => { affixingActions.backToMenuPage() }}>חזרה לבחירת טבלה</StyledButton>
            <StyledButton type="primary" onClick={() => { affixingActions.createRow() }}>חדש</StyledButton>
            <StyledButton type="primary" danger onClick={() => { affixingActions.deleteRow() }}>מחק</StyledButton>
            <StyledButton type="primary" onClick={() => { affixingActions.editRow() }}>ערוך</StyledButton>
          </ButtonsSection>
        </div>
      }
    </AffixingContainer>
